...
[A dashboard is available for exploring the data and the analyses performed](https://pablobernabeu.shinyapps.io/dutch-modality-exclusivity-norms/). [A summarised report is also available](https://www.linkedin.com/pulse/modality-exclusivity-norms-336-properties-411-dutch-english-bernabeu).
