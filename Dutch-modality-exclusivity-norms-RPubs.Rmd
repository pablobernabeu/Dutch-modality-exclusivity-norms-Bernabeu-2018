...
<a href="https://github.com/pablobernabeu/Modality-exclusivity-norms-747-Dutch-English-replication/blob/master/Dutch-modality-exclusivity-norms-RPubs.Rmd" style="color:#9FB05F; border-bottom:none !important;font-size: 15px; font-weight: bold; font-family: 'Courier New', Courier, monospace;"> <i class='fas fa-database' style='font-size:20px; color:#577787'></i> <i class='fab fa-r-project' style='font-size:20px; color:#526772'></i> Data and code for analyses and dashboard </a>
...
<i class="fas fa-table" title='Tab with table containing both property and concept words'></i> {#table style="position:absolute !important; background-color:#FCFCFC; data-width:100%;"}
=======================================================================
...
Properties {data-orientation=rows style="position: absolute !important;"}
=======================================================================
...
Concepts {data-orientation=rows style="position: absolute !important;"}
=======================================================================
...
<b> Comparison with Lynott and Connell's (2009, 2013) English norms ([data sets](http://www.lancaster.ac.uk/staff/connelll/lab/norms.html){target="_blank"}).</b> In both languages, properties were visibly more perceptual than concepts.
</div>
