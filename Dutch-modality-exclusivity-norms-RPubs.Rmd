...
### <span style = 'font-size: 16px !important;'> Principal component analysis (PCA; see loadings below) reflecting different relationships among the modalities (cf. <a href="#section-cf-lc-english-norms">Lynott & Connell's 2013 data for English</a>) </span> {style="text-align:justify; padding-top: 17px !important; padding-bottom: 5px !important; padding-left: 4px !important; padding-right: 4px !important;"}
...
### <span> <b>Loadings of principal components for properties (see 'PC' dependent variables above), in the form of correlations.</b> Coefficients above <i>r</i> = .70 (i.e., 50% shared variance) shown in bold. </span> {style="padding-top:8px; padding-bottom:5px; text-align:justify;"}
...
### <span> <b>Loadings of principal components for concepts (see 'PC' dependent variables above), in the form of correlations.</b> Coefficients above <i>r</i> = .70 (i.e., 50% shared variance) shown in bold. </span> {style="padding-top:8px; padding-bottom:5px; text-align:justify;"}
