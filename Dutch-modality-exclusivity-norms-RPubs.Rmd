...
Row {style="height:1100px; background-color:#FCFCFC;"}
--------------------------------------------------------

<div style = "padding-left: 30px; padding-right: 38px; text-align: justify; background-color: #FCFCFC;">

<div style="text-align: center; font-size: 18px; padding-top: 18px; margin-top: 2px; margin-bottom: 2px;"> This *RPubs* website is a reduced version of a dashboard. </div>

<!-- Link to source code on OSF.io -->
<div style = "text-align: center; padding-top: 12px; padding-bottom: 10px;"> <a href="https://pablobernabeu.shinyapps.io/Dutch-modality-exclusivity-norms/" style="border-bottom:none !important"> <button style = 'background-color:#FFF9F6; outline:#C3AEAE dotted 0.8px; font-size: 18px; font-weight: bold; font-family: "Courier New", Courier, monospace;'> <i class="fas fa-external-link-alt" aria-hidden="true" style='padding-top:4px; padding-bottom:6px; font-size:20px; color:#5A647B;'></i> See complete dashboard </button> </a> </div>
...
# 
#                   <p><i class="fas fa-book-open"></i> <a href="#info">References</a></p>
# 
#                   </div>'))
#   })
...
#         footnote(general = 'Correlations above r = .70 (i.e., over 50% shared variance) shown in bold.') %>%
...
### <span> <b>Loadings of principal components.</b> Correlations above <i>r</i> = .70 (i.e., over 50% shared variance) shown in bold. </span>
...
#                             cell_spec(PC2, "html")) ) %>%
#         kable(format = "html", escape = FALSE) %>%
#         footnote(general = 'Correlations above r = .70 (i.e., over 50% shared variance) shown in bold.', general_title = '') %>%
#         kable_styling('striped', full_width = F) %>%
#         column_spec(1, bold = T)
#       ),
#     size = 's', easyClose = TRUE, footer = modalButton("Close")
...
### <span> <b>Loadings of principal components (PC).</b> Correlations above <i>r</i> = .70 (i.e., over 50% shared variance) shown in bold. </span>
...
### <span style="padding-bottom:5px; text-align:justify;"> <b>Loadings of principal components</b> (see 'PC' dependent variables) for properties. Correlations above <i>r</i> = .70 (i.e., over 50% shared variance) shown in bold. </span>
...
### <span style="padding-bottom:5px; text-align:justify;"> <b>Loadings of principal components</b> (see 'PC' dependent variables) for concepts. Correlations above <i>r</i> = .70 (i.e., over 50% shared variance) shown in bold. </span>
