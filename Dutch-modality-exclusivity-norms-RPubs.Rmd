...
<div style = "padding-left: 60px; padding-right: 60px; padding-bottom:40px; text-align: justify; background-color: #FCFCFC;">
...
<div style = "background-color: #FCFCFC; text-align: justify; padding-top: 27px; padding-right: 60px; padding-left: 60px; padding-bottom: 38px; margin-top: 0; margin-bottom: 7px;">
...
### <span> <b>Loadings of principal components for properties (see 'PC' dependent variables above), in the form of correlations.</b> Coefficients above <i>r</i> = &plusmn;.70 (i.e., 50% shared variance) shown in bold. </span> {style="background-color:#FFFAF4; padding-top:8px; padding-bottom:5px; text-align:justify;"}
...
### <span> <b>Loadings of principal components for concepts (see 'PC' dependent variables above), in the form of correlations.</b> Coefficients above <i>r</i> = &plusmn;.70 (i.e., 50% shared variance) shown in bold. </span> {style="background-color:#FFFEF3; padding-top:8px; padding-bottom:5px; text-align:justify;"}
