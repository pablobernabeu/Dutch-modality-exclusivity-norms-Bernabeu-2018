...
Row {style="height:1350px; background-color:#FCFCFC;"}
--------------------------------------------------------

<div style = "padding-left: 30px; padding-right: 38px; text-align: justify; background-color: #FCFCFC;">

<div style="text-align: center; font-size: 18px; padding-top: 21px; margin-top: 2px; margin-bottom: 2px;"> This *RPubs* website is a reduced version of a dashboard. </div>

<!-- Link to source code on OSF.io -->
<div style = "text-align: center; padding-top: 12px; padding-bottom: 13px;"> <a href="https://pablobernabeu.shinyapps.io/Dutch-modality-exclusivity-norms/" style="border-bottom:none !important"> <button style = 'background-color:#FFF9F6; outline:#C3AEAE dotted 0.8px; font-size: 18px; font-weight: bold; font-family: "Courier New", Courier, monospace;'> <i class="fas fa-external-link-alt" aria-hidden="true" style='padding-top:4px; padding-bottom:6px; font-size:17px; color:#5A647B;'></i> See complete dashboard </button> </a> </div>
...
### <span> <b>Loadings of principal components (PC) in the form of correlations.</b> Coefficients above <i>r</i> = .70 (i.e., over 50% shared variance) shown in bold. </span>
...
### <span style="padding-bottom:5px; text-align:justify;"> <b>Loadings of principal components (see 'PC' dependent variables above), in the form of correlations, for properties</b>. Coefficients above <i>r</i> = .70 (i.e., over 50% shared variance) shown in bold. </span>
...
### <span style="padding-bottom:5px; text-align:justify;"> <b>Loadings of principal components (see 'PC' dependent variables above), in the form of correlations, for concepts</b>. Coefficients above <i>r</i> = .70 (i.e., over 50% shared variance) shown in bold. </span>
