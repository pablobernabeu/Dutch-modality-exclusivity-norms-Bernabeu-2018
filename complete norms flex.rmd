---
title: "Dutch modality exclusivity norms (Bernabeu et al., in prep.)"
output:
...
<!-- CSS formatting: 'Info' page margins -->
<style>
#section-info{
...
sliderInput("properties_Auditory", "Auditory score", min = 0, max = 5, value = c(0, 5), step = 0.3)


# Haptic

sliderInput("properties_Haptic", "Haptic score", min = 0, max = 5, value = c(0, 5), step = 0.3)


# Visual

sliderInput("properties_Visual", "Visual score", min = 0, max = 5, value = c(0, 5), step = 0.3)
...
renderPlot({
 ...
 ggplotly(
  ...
  geom_text(size = ifelse(selected_props()$word %in% highlighted_properties(), 7, 3),
...
sliderInput("concepts_Auditory", "Auditory score", min = 0, max = 5, value = c(0, 5), step = 0.3)


# Haptic

sliderInput("concepts_Haptic", "Haptic score", min = 0, max = 5, value = c(0, 5), step = 0.3)


# Visual

sliderInput("concepts_Visual", "Visual score", min = 0, max = 5, value = c(0, 5), step = 0.3)
...
The linguistic materials, and any others such as code, are available for re-use, provided acknowledgment of the publication below ([CC-By licence](https://creativecommons.org/licenses/by/4.0/)).
...
Pablo Bernabeu. [Website](http://www.research.lancs.ac.uk/portal/en/people/pablo-de-juan-bernabeu). p.bernabeu@lancaster.ac.uk.
...
img <- readPNG('C:/Users/Pablo/Dropbox/STUDIES/R/Experiment Data/Modality norms/allfour_lowres.png')
grid.raster(img)
