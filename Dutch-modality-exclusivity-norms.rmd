...
# Pop-ups with definitions and corpora

actionLink('properties_DefinitionsCorporaLink', HTML('<span style="font-size: 14px; padding-top: 3px; border-bottom:none !important"><i class="far fa-clipboard" aria-hidden="true"></i> Definitions and corpora </span>'))
...
observeEvent(input$properties_DefinitionsCorporaLink, {
  sendSweetAlert(session, type = NULL, title = NULL, html = TRUE,
                 ...
                 text = HTML('<div style = "font-size = 14px; text-align: justify;">
                  ...
                  <p><b>PCA:</b> Method for reducing dimensionality of data while retaining the main patterns (<a href="https://www.nature.com/articles/nmeth.4346">read more</a>).</p>
...
actionLink('Concs_DefinitionsCorporaLink', HTML('<span style="font-size: 14px; padding-top: 3px; border-bottom:none !important"><i class="far fa-clipboard" aria-hidden="true"></i> Definitions and corpora </span>'))

observeEvent(input$Concs_DefinitionsCorporaLink, {
  sendSweetAlert(session, type = NULL, title = NULL, html = TRUE,
                 closeOnClickOutside = TRUE, btn_labels = 'Close',
                 text = HTML('<div style = "font-size = 14px; text-align: justify;">
...
<b> Comparison with Lynott and Connell's (2009, 2013) English norms ([data sets](http://www.lancaster.ac.uk/staff/connelll/lab/norms.html)).</b> <span style='font-size:12px'> Tabs may be shifted above, and plots are interactive.</span>
</div>
