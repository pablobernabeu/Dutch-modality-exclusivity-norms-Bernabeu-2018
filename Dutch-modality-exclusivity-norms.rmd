...
author: '<a href="#section-info" style="color:#EFF5FF !important; text-decoration:none !important; font-size:10px"> Bernabeu et al. (2017) </a>'
output:
...
These modality exclusivity norms for Dutch were created to facilitate research about language (see also Speed & Majid, 2017). Forty-two respondents rated the properties and concepts sepately and in blocks, with an average of eight respondents per word, a minimum of five, and a maximum of nine. The [instructions](https://osf.io/ungey/) to participants were similar to those used by Lynott and Connell (2009, 2013), except that we elicited three modalities (auditory, haptic, visual) instead of five.
...
<div style = "padding-top: 5px; padding-left: 25px; padding-bottom: 15px; float: right; width: 22%; font-size: 85%; text-align: justify;"><img style = "padding-right: 5px; padding-left: 5px;" src="https://upload.wikimedia.org/wikipedia/commons/e/e7/Booba-Kiki.svg" alt="Booba-Kiki" width=90% height=90% style="padding-bottom:0.5em;" />Bouba-Kiki effect demonstrating sound symbolism. When asked to match the words 'bouba' and 'kiki' to these objects, most people name the spiky object 'kiki' and the rounded object 'bouba' (Köhler, 1929). <br></br> <span style="font-size:65%; line-height:5% !important;"> https://commons.wikimedia.org/wiki/File:Booba-Kiki.svg. Monochrome version 1 June 2007 by BendžVectorized with Inkscape --Qef (talk) 21:21, 23 June 2008 (UTC) [CC BY-SA 3.0 (http://creativecommons.org/licenses/by-sa/3.0/)]] </span> </div>

The norms also served to investigate [sound symbolism](#sound-symbolism){style='background-color:#F2F7FF'}, which is the relation between the form of words and their meaning. The form of words rests on their sound more than on their visual or tactile properties (for oral speakers, at least). Therefore, the auditory ratings of words should more reliably predict their lexical properties (length, frequency, distinctiveness) than would haptic of visual ratings. By means of regression analyses following Lynott and Connell (2013; see [Table 6](https://link.springer.com/article/10.3758%2Fs13428-012-0267-0#Sec4)), we found that auditory ratings were either the best predictor, or yielded a different polarity to the haptic and visual ratings, thus demonstrating sound symbolism.
...
<div style = "background-color: #FCFCFC; text-align: center; font-size: 15px; padding-top: 17px; padding-bottom: 5px;">
