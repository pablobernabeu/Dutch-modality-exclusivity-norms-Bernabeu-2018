...
modalities_labels = c(
  sprintf('<span style="background-color:#ff3030; color:white; font-weight:bold; padding-left:2px; padding-right:1px; padding-bottom:2px;"> &nbsp; Auditory &nbsp; </span>'),
  sprintf('<span style="background-color:dodgerblue; color:white; font-weight:bold; padding-left:2px; padding-right:1px; padding-bottom:2px;"> &nbsp; Haptic &nbsp; </span>'),
  sprintf('<span style="background-color:forestgreen; color:white; font-weight:bold; padding-left:2px; padding-right:1px; padding-bottom:2px;"> &nbsp; Visual &nbsp; </span>')
)
