...
<!-- Enable icons by loading the CSS library -->
<head>
...
actionLink("properties_lexicals_loadings", 
	HTML('<p style = "background-color:#F7F7F7; outline:#C3AEAE dotted 0.8px; padding:6px; padding-top:4px;"> <span class="glyphicon glyphicon-th" aria-hidden="true"></span> Loadings of principal components for properties.</p>'))
...
<div style = "background-color: #FEFEFE; text-align: justify; padding-top: 15px; padding-right: 30px; padding-left: 30px">
...
actionLink("concepts_lexicals_loadings",
	HTML('<p style = "background-color:#F7F7F7; outline:#C3AEAE dotted 0.8px; padding:6px; padding-top:4px;"> <span class="glyphicon glyphicon-th" aria-hidden="true"></span> Loadings of principal components for concepts.</p>'))
