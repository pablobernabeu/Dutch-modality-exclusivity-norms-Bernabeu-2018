...
author: '<a href="#section-info" style="color:#CCD8FF !important; text-decoration:none !important; font-size:10px"> Bernabeu et al. (2017) </a>'
output:
...
<div style = "text-align: right; padding-top: 30px; padding-bottom: 0; padding-right: 38px;"> <a href="https://osf.io/bx2d7/" style="border-bottom:none !important"> <button style = 'background-color:#FFF9F6; outline:#C3AEAE dotted 0.8px; font-size: 15px; font-weight: bold; font-family: "Courier New", Courier, monospace;'> <i class="fab fa-r-project" aria-hidden="true" style='padding-top:4px; padding-bottom:6px; font-size:20px; color:#5A647B;'></i> Code for analyses and dashboard <span style = "font-size: 9px">(CC-BY licensed)</span> </button> </a> </div>
...
These norms were validated in an experiment showing that shifts across trials with different dominant modalities (e.g., visual versus auditory) incurred semantic processing costs ([Bernabeu, Willems, & Louwerse, 2017](https://mindmodeling.org/cogsci2017/papers/0318/index.html)). All data for that study are [available](https://osf.io/97unm/wiki/home/), including a [dashboard](https://pablobernabeu.shinyapps.io/ERP-waveform-visualization_CMS-experiment/).

The [properties](#properties){style='background-color:#F2F7FF'} and the [concepts](#concepts){style='background-color:#F2F7FF'} were separately analysed. Properties were more strongly perceptual than concepts. Distinct relationships also emerged among the modalities emerged, with the visual and haptic modalities being closely related, and the auditory modality being relatively independent ([cf. Lynott & Connell's data for English](#cf-lc-english-norms){style='background-color:#F2F7FF'}). This ties in with findings that, in conceptual processing, modalities can be collated based on language statistics (Louwerse & Connell, 2011).
...
<div style="text-align: justify !important; padding-top: 0 !important;"> When people are asked to match the words 'bouba' and 'kiki' to the above objects, most name the rounded object 'bouba' and the spiky one 'kiki'. This has been interpreted as sound symbolism, insofar as pronouncing the word 'bouba' puts the lips into a more rounded shape than 'kiki' does (Köhler, 1929; see also Cuskley, Simner, & Kirby, 2017). </div>
...
The norms also served to investigate [sound symbolism](#sound-symbolism){style='background-color:#F2F7FF'}, which is the relation between the form of words and their meaning. The form of words rests on their sound more than on their visual or tactile properties (at least in spoken language). Therefore, auditory ratings should more reliably predict the lexical properties of words (length, frequency, distinctiveness) than haptic or visual ratings would. Lynott and Connell's (2013) findings were replicated, as auditory ratings were either the best predictor of lexical properties, or yielded a different polarity from the haptic and visual ratings.
...
observeEvent(input$properties_DefinitionsCorporaLink, {
  sendSweetAlert(session, type = NULL, title = NULL, html = TRUE,
                 ...
                 text = HTML('<div style = "font-size = 14px; text-align: justify;">
                  ...
                  <p style="font-size:11px !important; padding-bottom:4px;">* Calculated following <a href="#info"> Lynott and Connell (2009, 2013)</a>.</p>
...
observeEvent(input$properties_loadings, {
  showModal(modalDialog(
    title = HTML('<div style="padding-bottom:0px; font-size:14px;"> <b>Loadings of principal components (PC) in the form of correlations.</b> Coefficients above <i>r</i> = .70 (i.e., over 50% shared variance) shown in bold. </div>'),
...
<div><span data-toggle="tooltip1" data-placement="bottom" title=" &nbsp; Defined as in Lynott and Connell (2009, 2013). " style="border-bottom: 0.9px dotted grey"><b> Dominant modality: </b></span> Highest-rated modality. </div>

<div style="padding-top:5px;"><span data-toggle="tooltip1" data-placement="bottom" title=" &nbsp; Defined as in Lynott and Connell (2009, 2013). " style="border-bottom: 0.9px dotted grey"><b> Modality exclusivity: </b></span> Range of the three modality ratings divided by the sum. </div>

<div style="padding-top:5px; padding-bottom:6px;"><span data-toggle="tooltip1" data-placement="bottom" title=" &nbsp; Defined as in Lynott and Connell (2009, 2013). " style="border-bottom: 0.9px dotted grey"><b> Perceptual strength: </b> </span> Highest rating across modalities. </div>
...
### Principal component analysis (PCA) reflecting different relationships among the modalities. Result plotted by word and dominant modality. When the three modalities are reduced to two principal components, the visual and haptic modalities load on the components similarly--both with positive polarities--, whereas the auditory modality is relatively independent--with a negative polarity (cf. [Lynott & Connell, 2009](#cf-lc-english-norms)). {style='padding-top:13px'}
 ...
 ggplotly(
  ggplot( selected_props(), aes(RC1, RC2, label = as.character(word), color = main, 
    ...
    text = paste0(' ', '<span style="padding-top:3px; padding-bottom:3px; font-size:2em; color:#EEEEEE">', capitalize(word), '</b></span> ',
			...
			' ', '</b><br><span style="color:#EEEEEE"> Exclusivity: </span><b style="color:#EEEEEE">', round(Exclusivity, 2), '% ',
			'</b><br><span style="color:#EEEEEE"> Auditory: </span><b style="color:#EEEEEE">', round(Auditory, 2), ' ',
			'</b><br><span style="color:#EEEEEE"> Haptic: </span><b style="color:#EEEEEE">', round(Haptic, 2), ' ',
			'</b><br><span style="color:#EEEEEE"> Visual: </span><b style="color:#EEEEEE">', round(Visual, 2), ' ',
...
### Principal component analysis (PCA) reflecting different relationships among the modalities. Result plotted by word and dominant modality. When the three modalities are reduced to two principal components, visual and haptic ratings share one component, whereas the auditory modality is relatively independent, having its own component (cf. [Lynott & Connell, 2013](#cf-lc-english-norms)). {style='padding-top:13px'}
...
<b> Comparison with Lynott and Connell's (2009, 2013) English norms ([data sets](http://www.lancaster.ac.uk/staff/connelll/lab/norms.html))</b>
</div>
...
ggplotly( ggplot(eng_props,
  aes(RC1, RC2, label = as.character(word_eng), color = main_eng,
    text = paste0(' ', '<span style="padding-top:3px; padding-bottom:3px; font-size:2em; color:#EEEEEE">', capitalize(word_eng), '</b></span> ',
			...
			' ', '</b><br><span style="color:#EEEEEE"> Exclusivity: </span><b style="color:#EEEEEE">', round(exc_eng, 2) * 100, '% ',  
			# Multiplied by 100 to make percentage
			'</b><br><span style="color:#EEEEEE"> Auditory: </span><b style="color:#EEEEEE">', round(Aud_eng, 2), ' ',
			'</b><br><span style="color:#EEEEEE"> Haptic: </span><b style="color:#EEEEEE">', round(Hap_eng, 2), ' ',
			'</b><br><span style="color:#EEEEEE"> Visual: </span><b style="color:#EEEEEE">', round(Vis_eng, 2), ' ',
...
ggplotly( ggplot(concepts_Dutch,
  aes(RC1, RC2, label = as.character(word), color = main,
    ...
    text = paste0(' ', '<span style="padding-top:3px; padding-bottom:3px; font-size:2em; color:#EEEEEE">', capitalize(word), '</b></span> ',
			'</b><br><span style="color:#EEEEEE"> Dominant modality: </span><b style="color:#EEEEEE">', main, ' ',
			'</b><br><span style="color:#EEEEEE"> Perceptual strength: </span><b style="color:#EEEEEE">', round(Perceptualstrength, 2), ' ', 			'</b><br><span style="color:#EEEEEE"> Exclusivity: </span><b style="color:#EEEEEE">', round(Exclusivity, 2), '% ',  
			# Multiplied by 100 to make percentage
			'</b><br><span style="color:#EEEEEE"> Auditory: </span><b style="color:#EEEEEE">', round(Auditory, 2), ' ',
			'</b><br><span style="color:#EEEEEE"> Haptic: </span><b style="color:#EEEEEE">', round(Haptic, 2), ' ',
			'</b><br><span style="color:#EEEEEE"> Visual: </span><b style="color:#EEEEEE">', round(Visual, 2), ' ',
...
observeEvent(input$properties_lexicals_loadings, {
  showModal(modalDialog(
    title = HTML('<div style="padding-bottom:0px; padding-left:2px; font-size:14px; text-align:justify;"> <b>Loadings of principal components (see \'PC\' dependent variables), in the form of correlations, for properties</b>. Coefficients above <i>r</i> = .70 (i.e., over 50% shared variance) shown in bold. </div>'),
    HTML( 	# Below, table constructed
      properties_lexicals_loadings %>%
      # Highlight correlations above .7
        mutate(PC1 = ifelse(abs(as.numeric(PC1)) > .7, cell_spec(PC1, "html", bold = TRUE, color = 'black'),
...
**Sound symbolism is the relation between the form of words and their meaning.** The form of words rests on their sound more than on their visual or tactile properties (at least in spoken language). Therefore, auditory ratings should more reliably predict the lexical properties of words (length, frequency, distinctiveness) than haptic or visual ratings would. By means of regression analyses following Lynott and Connell (2013; see [Table 6](https://link.springer.com/article/10.3758%2Fs13428-012-0267-0#Sec4)), we found that auditory ratings were either the best predictor of lexical properties, or yielded a different polarity from the haptic and visual ratings, thus demonstrating sound symbolism. Standardised coefficients ($\beta$) presented below, with asterisks indicating significance (<sup>\*\*\*</sup>*p* < .001; <sup>\*\*</sup>*p* < .01; <sup>\*</sup>*p* < .05). Regression assumptions observed, i.e., normal distribution of residuals (transformations attempted), largest variance inflation factor < 10 and its mean around 1, tolerance > 0.2 ([Field, Miles, & Field, 2012](#info)). [External corpora used](#info). 'PC' = Kaiser-normalised, varimax-rotated principal component.
...
observeEvent(input$concepts_lexicals_loadings, {
  showModal(modalDialog(
    title = HTML('<div style="padding-bottom:0px; padding-left:2px; font-size:14px; text-align:justify;"> <b>Loadings of principal components (see \'PC\' dependent variables), in the form of correlations, for concepts</b>. Coefficients above <i>r</i> = .70 (i.e., over 50% shared variance) shown in bold. </div>'),
    HTML( 	# Below, table constructed
      concepts_lexicals_loadings %>%
      # Highlight correlations above .7
        mutate(PC1 = ifelse(abs(as.numeric(PC1)) > .7, cell_spec(PC1, "html", bold = TRUE, color = 'black'),
...
### <span style="font-size:1.7em; color:black;"> &nbsp; **Properties** </span> {style="background-color:#FFFAF4; padding-top:0px; padding-bottom:15px !important; margin-bottom:2px !important;"}
...
### <span style="font-size:1.7em; color:black;"> &nbsp; **Concepts** </span> {style="background-color:#FFFEF3; padding-top:0px; padding-bottom:15px !important; margin-bottom:2px !important;"}
