...
observeEvent(input$properties_loadings, {
  showModal(modalDialog(
    title = HTML('<div style="padding-bottom:0px; font-size:14px;"> <b>Loadings of principal components (PC) in the form of correlations.</b> Coefficients above <i>r</i> = .70 (i.e., 50% shared variance) shown in bold. </div>'),
