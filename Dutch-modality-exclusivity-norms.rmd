...
renderReactable({
  reactable(selected_words(),
            ...
            striped = TRUE, pagination = FALSE, highlight = TRUE,
            ...
            columns = list(
              ...
              Exclusivity = colDef(cell = function(value) { 
                ...
                header = with_tooltip('Modality Exclusivity',
                                      'Range of the three modality ratings divided by the sum (as defined in Lynott & Connell, 2009, 2013). Value ranges colour-coded from grey to dark violet.'),
              ...
              Perceptualstrength = colDef(format = colFormat(digits = 2),
                                          header = with_tooltip('Perceptual Strength',
                                                         'Highest rating across modalities (as defined in Lynott & Connell, 2009, 2013). Value ranges colour-coded from grey to dark violet.'),
                                          style = function(value) {
                                            if (value < 1.7) {
                                              color = '#9D9D9D'
                                              } else if (value < 3.3) {
              ...
              Auditory = colDef(header = with_tooltip('Auditory Rating',
                                                      'Mean rating of each word on the auditory modality across participants. Value ranges colour-coded from grey to dark violet.'),
                                style = function(value) {
                                  if (value < 1.7) {
                                    color = '#9D9D9D'
                                    } else if (value < 3.3) {
              ...
              Haptic = colDef(header = with_tooltip('Haptic Rating', 
                                                      'Mean rating of each word on the haptic (tactile) modality across participants. Value ranges colour-coded from grey to dark violet.'),
                                style = function(value) {
                                  if (value < 1.7) {
                                    color = '#9D9D9D'
                                    } else if (value < 3.3) {
              ...
              Visual = colDef(header = with_tooltip('Visual Rating', 'Mean rating of each word on the visual modality across participants. Value ranges colour-coded from grey to dark violet.'),
                                style = function(value) {
                                  if (value < 1.7) {
                                    color = '#9D9D9D'
                                    } else if (value < 3.3) {
