...
<!-- Enable icons by loading Bootstrap library -->
<head>
<link rel = "stylesheet" href = "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
</head>

<!-- Define CSS style for customising output to specific screen sizes (i.e., for recommending larger screen) -->
<style type = "text/css">
...
[<span class="glyphicon glyphicon-new-window" aria-hidden="true"></span> Norms data set](https://osf.io/58gzs/)
...
actionLink("properties_loadings", " Loadings of principal components", class = 'fa fa-table')
...
output$properties_csv = downloadHandler(
  filename = function() {
    paste0('Selected-data-Dutch-modality-norms-Bernabeu-', Sys.time(), '.csv') },
...
output$properties_png = downloadHandler(
  filename = function() {
    paste0('Selected-data-Dutch-modality-norms-Bernabeu-', Sys.time(), '.png') },
	content <- function(file){
...
actionLink("concepts_loadings", " Loadings of principal components", class = "fa fa-table")
...
Sound symbolism {data-orientation=rows data-padding=2}
=======================================================================

Row {data-height=20% data-padding=2}
-----------------------------------------------------------------------
...
describe(complete.cases(props_Dutch2[complete.cases(props_Dutch2$Exclusivity),]
$phonemes_DUTCHPOND))
describe(complete.cases(props_Dutch2[complete.cases(props_Dutch2$Exclusivity),]
...
describe(complete.cases(concs_Dutch2[complete.cases(concs_Dutch2$Exclusivity),]
$phonemes_DUTCHPOND))
describe(complete.cases(concs_Dutch2[complete.cases(concs_Dutch2$Exclusivity),]
$phon_neighbours_DUTCHPOND))
describe(complete.cases(concs_Dutch2[complete.cases(concs_Dutch2$Exclusivity),]
...
<div style = "background-color: #FEFEFE; padding-top: 8px; padding-left: 15px; padding-right: 1px;">
...
actionLink("properties_lexicals_loadings", 
	HTML('<p style = "background-color:#F9F9F9; outline:#C3AEAE dotted 0.8px; padding:6px; padding-top:4px;"> <span class="glyphicon glyphicon-th" aria-hidden="true"></span> Loadings of principal components for properties.</p>'))
...
actionLink("concepts_lexicals_loadings",
	HTML('<p style = "background-color:#F9F9F9; outline:#C3AEAE dotted 0.8px; padding:6px; padding-top:4px;"> <span class="glyphicon glyphicon-th" aria-hidden="true"></span> Loadings of principal components for concepts.</p>'))
...
Row {data-height=80% data-padding=2}
-----------------------------------------------------------------------

### <span style="font-size:1.7em; color: #000000;"> &nbsp; **Properties** </span>
...
### <span style="font-size:1.7em; color: #000000;"> &nbsp; **Concepts** </span>
