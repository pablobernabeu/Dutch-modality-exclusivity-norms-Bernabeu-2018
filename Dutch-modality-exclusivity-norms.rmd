...
<div style = "text-align: right; padding-top: 30px; padding-bottom: 0; padding-right: 38px;"> <a href="https://osf.io/bx2d7/" style="border-bottom:none !important"> <button style = 'background-color:#FFF9F6; outline:#C3AEAE dotted 0.8px; font-size: 15px; font-weight: bold; font-family: "Courier New", Courier, monospace;'> <i class="fab fa-r-project" aria-hidden="true" style='padding-top:4px; font-size:20px; color:#5A647B;'></i> Code for analyses and dashboard <span style = "font-size: 10px">(CC-BY licensed)</span> </button> </a> </div>
...
These modality exclusivity norms for Dutch served a twofold purpose: first, the creation of linguistic stimuli (see also Speed & Majid, 2017), and second, the replication of Lynott and Connell's (2009, 2013) analyses. 

Forty-two respondents rated the properties and concepts separately and in blocks, with an average of eight respondents per word, a minimum of five, and a maximum of nine. The [instructions](https://osf.io/ungey/) to participants were similar to those used by Lynott and Connell (2009, 2013), except that we elicited three modalities (auditory, haptic, visual) instead of five.
...
The [properties](#properties){style='background-color:#F2F7FF'} and the [concepts](#concepts){style='background-color:#F2F7FF'} were separately analysed. Both sets demonstrated distinct relationships among modalities, whereby the visual and haptic modalities were close together, whereas the auditory modality was relatively independent, as shown by principal component analysis ([cf. Lynott & Connell's data for English](#cf-lc-english-norms){style='background-color:#F2F7FF'}). This ties in with findings that conceptual processing in language can collate modalities based on language statistics (Louwerse & Connell, 2011).

<div style = "padding-top: 5px; padding-left: 25px; padding-bottom: 8px; float: right; width: 22%; font-size: 85%; text-align: justify;"><img style = "padding-right: 5px; padding-left: 5px;" src="https://upload.wikimedia.org/wikipedia/commons/e/e7/Booba-Kiki.svg" alt="Bouba-Kiki" width=90% height=90% style="padding-bottom:0.5em;" /> When people are asked to match the words 'bouba' and 'kiki' to the above objects, most name the rounded object 'bouba' and the spiky one 'kiki'. This has been interpreted as sound symbolism, insofar as pronouncing the word 'bouba' puts the lips into a more rounded shape than 'kiki' does (Köhler, 1929; see also Cuskley, Simner, & Kirby, 2017). <div style="font-size:65%; padding-top:6px;"> https://commons.wikimedia.org/wiki/File:Booba-Kiki.svg. Monochrome version 1 June 2007 by BendžVectorized with Inkscape --Qef (talk) 21:21, 23 June 2008 (UTC) [CC BY-SA 3.0 (http://creativecommons.org/licenses/by-sa/3.0/)]] </div> </div>
