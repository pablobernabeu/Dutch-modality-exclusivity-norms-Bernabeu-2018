...
<i class="fas fa-table"></i> {#table style="position:absolute !important; background-color:#FCFCFC;"}
=======================================================================
...
sliderInput("table_InflectedContextualDiversity", "Inflected adjective CD", min = 0, max = 4, value = c(0, 4), step = 0.1)
...
### **Filterable table containing both property and concept words**. Table composed of multiple columns; please scroll horizontally and vertically. Column information available by hovering on header. Columns may be simultaneously filtered and sorted (e.g., to find out range), and words may be searched below the header. Mean values displayed at bottom of table. CSV spreadsheet [also available](https://osf.io/ge7pn/){target="_blank"}.
...
table_data = all[!is.na(all$word), c('cat', 'conc_cat', 'word', 'inflected_prop', 'main', 'Exclusivity', 'Perceptualstrength', 'Auditory', 
                                     'Haptic', 'Visual', 'concrete_Brysbaertetal2014', 'letters', 'phonemes_DUTCHPOND', 
                                     'freq_lg10CD_SUBTLEXNL', 'inflected_adj_freq_lg10CD_SUBTLEXNL', 'freq_lg10WF_SUBTLEXNL', 'freq_CELEX_lem', 
                                     'phon_neighbours_DUTCHPOND', 'orth_neighbours_DUTCHPOND', 'AoA_Brysbaertetal2014'
                                     )]
...
renderReactable({
  reactable(selected_words(),
            ...
            striped = TRUE, height = 26800, pagination = FALSE, highlight = TRUE,
            ...
            columns = list(
              ...
              Exclusivity = colDef(format = colFormat(percent = TRUE, digits = 2),
                                   header = with_tooltip('Modality Exclusivity',
                                                         'Range of the three modality ratings divided by the sum (as defined in Lynott & Connell, 2009, 2013). Ranges colour-coded from grey to dark violet.'),
                                   ...
                                   # On line below, multiply by 100 because original values were in % format
                                   footer = function(values) paste0(round(mean(values),2) *100,'%')),

              Perceptualstrength = colDef(format = colFormat(digits = 2),
                                          header = with_tooltip('Perceptual Strength',
                                                         'Highest rating across modalities (as defined in Lynott & Connell, 2009, 2013). Ranges colour-coded from grey to dark violet.'),
                                          style = function(value) {
                                            if (value < 1.7) {
                                              color = '#9D9D9D'
                                              } else if (value < 3.3) {
              ...
              Auditory = colDef(header = with_tooltip('Auditory Rating',
                                                      'Mean rating of each word on the auditory modality across participants. Ranges colour-coded from grey to dark violet.'),
                                style = function(value) {
                                  if (value < 1.7) {
                                    color = '#9D9D9D'
                                    } else if (value < 3.3) {
              ...
              Haptic = colDef(header = with_tooltip('Haptic Rating', 
                                                      'Mean rating of each word on the haptic (tactile) modality across participants. Ranges colour-coded from grey to dark violet.'),
                                style = function(value) {
                                  if (value < 1.7) {
                                    color = '#9D9D9D'
                                    } else if (value < 3.3) {
              ...
              Visual = colDef(header = with_tooltip('Visual Rating', 'Mean rating of each word on the visual modality across participants. Ranges colour-coded from grey to dark violet.'),
                                style = function(value) {
                                  if (value < 1.7) {
                                    color = '#9D9D9D'
                                    } else if (value < 3.3) {
              ...
              letters = colDef(header = with_tooltip('Letters', 'Number of letters'),
                                                  format = colFormat(digits = 0),
                                                  footer = function(values) round(mean(values),0)),
              ...
              inflected_adj_freq_lg10CD_SUBTLEXNL = colDef(header = with_tooltip('Inflected Adjective CD',
                                                                   "An advanced measure of word frequency for 'Inflected Adjective' column, based on SUBTLEX-NL corpus (Keuleers, Brysbaert, & New, 2010). Zeros are shown for concepts, although no value applies, and these values do not affect mean."),
                                             format = colFormat(digits = 2), minWidth = 120,
                                             footer = function(values) round(sum(values)/336,2)),  # This average thus calculated to keep denominator to number of properties, without concepts.
...
sliderInput("properties_InflectedContextualDiversity", "Inflected adjective CD", min = 0, max = 4, value = c(0, 4), step = 0.1)
...
### **Property words**. Table composed of multiple columns; please scroll horizontally and vertically. Column information available by hovering on header. Columns may be simultaneously filtered and sorted (e.g., to find out range), and words may be searched below the header. Mean values displayed at bottom of table. CSV spreadsheet [also available](https://osf.io/ge7pn/){target="_blank"}.
  ...
  reactable(selected_props()[properties_columns],
            ...
            columns = list(
              ...
              Exclusivity = colDef(format = colFormat(percent = TRUE, digits = 2),
                                   ...
                                   # On line below, multiply by 100 because original values were in % format
                                   footer = function(values) paste0(round(mean(values),2),'%')),
...
### **Concept words.** Table composed of multiple columns; please scroll horizontally and vertically. Column information available by hovering on header. Columns may be simultaneously filtered and sorted (e.g., to find out range), and words may be searched below the header. Mean values displayed at bottom of table. CSV spreadsheet [also available](https://osf.io/ge7pn/){target="_blank"}.
...
# Variables to have to on table
concepts_columns = c('word','main','conc_cat','Exclusivity','Perceptualstrength','Auditory','Haptic','Visual',
                     'concrete_Brysbaertetal2014','letters','phonemes_DUTCHPOND','freq_lg10CD_SUBTLEXNL',
                     'freq_lg10WF_SUBTLEXNL','freq_CELEX_lem','phon_neighbours_DUTCHPOND',
                     'orth_neighbours_DUTCHPOND','AoA_Brysbaertetal2014')
