...
a:link {
  color: #3C6CA7;
  border-bottom: 0.1px dotted #5277A5
}
...
<div style = "text-align: center; padding-top: 15px; padding-bottom: 10px;"> <button style = 'background-color:#FFF9F6; outline:#C3AEAE dotted 0.8px; font-size: 18px; font-weight: bold; font-family: "Courier New", Courier, monospace;'> <a href="https://osf.io/bx2d7/" style="border-bottom:none !important"> <i class="fab fa-r-project" aria-hidden="true" style='padding-top:4px; font-size:20px; color:#5A647B;'></i> Code for analyses and dashboard <span style = "font-size: 10px">(CC-BY licensed)</span> </a> </i> </button> </div>
