...
actionLink("properties_loadings", " Principal component loadings", class = 'fa fa-table')

observeEvent(input$properties_loadings, {
  showModal(modalDialog(
    title = HTML('<div> Pearson correlation coefficients (<i>r</i>) </div>'),
...
**PCA**: Classical technique to reduce dimensionality of data while retaining the major patterns ([more](https://www.nature.com/articles/nmeth.4346)).
...
### Principal component analysis (PCA) reflecting different relationships among the modalities. Result plotted by word and dominant modality. When the three modalities are reduced to two principal components, visual and haptic ratings share one component, thus replicating [Lynott and Connell (2009, 2013)](#cf-lc-english-norms). 
...
renderPlotly({
 ggplotly(
  ...
  theme( plot.background = element_blank(), panel.grid.major = element_blank(),
         ...
         axis.title.y = element_text(colour = 'black', size = 12, margin = margin(0,15,15,15)),
...
actionLink("concepts_loadings", " Principal component loadings", class = 'fa fa-table')

observeEvent(input$concepts_loadings, {
  showModal(modalDialog(
    title = HTML('Pearson correlation coefficients (<i>r</i>)'),
    HTML( 	# Below, table constructed
      concepts_modality_loadings %>%
        # Highlight correlations above .7
        mutate(PC1 = ifelse(abs(as.numeric(PC1)) > .7, cell_spec(PC1, "html", bold = TRUE, color = 'black'), 
...
### &nbsp;&nbsp;&nbsp; [Reanalysis of Lynott and Connell's (2013)](https://doi.org/10.3758/s13428-012-0267-0) English concepts narrowed to three modalities
...
actionLink("properties_lexicals_loadings",
           HTML('<p style = "background-color:#F9F9F9; outline:#C3AEAE dotted 0.8px; padding-top:4px; padding-bottom:0px; padding-left:6px; padding-right:6px;"> <span class="glyphicon glyphicon-th" aria-hidden="true"></span> Principal component loadings for properties.</p>'))
...
actionLink("concepts_lexicals_loadings",
           HTML('<p style = "background-color:#F9F9F9; outline:#C3AEAE dotted 0.8px; padding-top:4px; padding-bottom:0px; padding-left:6px; padding-right:6px;"> <span class="glyphicon glyphicon-th" aria-hidden="true"></span> Principal component loadings for concepts.</p>'))
...
<div style = "text-align: center; padding-top: 10px; padding-bottom: 6px;"> <button style = "text-align: center; background-color:#FFF9F6; outline:#C3AEAE dotted 0.8px; font-size:18px"> <a href = "https://osf.io/bx2d7/"> <i class="fab fa-r-project" aria-hidden="true" style='font-size:22px; color:#3C3C3C'></i> &#8201; Code for analyses and dashboard <span style = "font-size: 10px">(CC-BY licensed)</span> </a> </i> </button> </div>

<div style = "padding-left: 30px; padding-right: 38px; text-align: justify; background-color:#FCFCFC;">

#### Information

These Dutch modality norms were created to facilitate research about language. Forty-two respondents rated the properties and concepts sepately and in blocks, with an average of eight respondents per word, a minimum of five, and a maximum of nine. The [instructions](https://osf.io/ungey/) were similar to those in Lynott and Connell (2009, 2013), but three modalities were elicited instead of five.
