...
<div style = "padding-right: 0 !important; padding-left: 0 !important; text-align: center !important; padding-bottom:0.5em;"><img src="https://upload.wikimedia.org/wikipedia/commons/e/e7/Booba-Kiki.svg" alt="Bouba-Kiki" width=80px height=80px></img></div> 
<div style="text-align: justify !important;"> When people are asked to match the words 'bouba' and 'kiki' to the above objects, most name the rounded object 'bouba' and the spiky one 'kiki'. This has been interpreted as sound symbolism, insofar as pronouncing the word 'bouba' puts the lips into a more rounded shape than 'kiki' does (Köhler, 1929; see also Cuskley, Simner, & Kirby, 2017). </div> 
