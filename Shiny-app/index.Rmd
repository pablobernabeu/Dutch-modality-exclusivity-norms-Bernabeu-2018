...
# 'Contextual diversity (CD)' treats absent words in the same way. The divisor
# follows the selection, whereas it used to be fixed at 336, which understated the
# mean after any filtering.
