...
author: '<a href="#info" style="color:#E4E5E8 !important; text-decoration:none !important; font-size:10px"> Bernabeu et al. (2017) </a>'
output:
  flexdashboard::flex_dashboard:
    theme: 'spacelab'
    orientation: columns
    vertical_layout: scroll
    source_code: "https://github.com/pablobernabeu/Modality-exclusivity-norms-747-Dutch-English-replication/blob/master/Shiny-app%2FDutch-modality-exclusivity-norms.rmd"
...
Info {style="background-color:#FCFCFC; data-width:100%; width: 900px; margin: 0 auto;"}
=======================================================================
...
<!-- Links -->
<div style = "text-align: right; padding-top: 30px; padding-bottom: 0; padding-right: 38px;">
...
<div style = "padding-top: 0px; padding-left: 30px; padding-right: 38px; text-align: justify; background-color:#FCFCFC;">
...
<div style = "padding-top: 5px; padding-left: 25px; padding-bottom: 8px; float: right; width: 22%; font-size: 85%;">
<div style = "text-align: center !important; padding-right: 0 !important; padding-left: 0 !important; padding-bottom: 0 !important;"><img src="https://upload.wikimedia.org/wikipedia/commons/e/e7/Booba-Kiki.svg" alt="Bouba-Kiki" width=80px height=55px></img></div>
<div style="text-align: justify !important; padding-top: 0 !important;"> When people are asked to match the pseudowords *bouba* and *kiki* to the above objects, most name the rounded object *bouba* and the spiky one *kiki*. This has been interpreted as sound symbolism, insofar as pronouncing *bouba* puts the lips into a more rounded shape than pronouncing *kiki* does (Köhler, 1929; Sourav et al., 2019). </div>
<div style="font-size:65%; padding-top:6px;"> https://commons.wikimedia.org/wiki/File:Booba-Kiki.svg. Monochrome version 1 June 2007 by BendžVectorized with Inkscape --Qef (talk) 21:21, 23 June 2008 (UTC) [CC BY-SA 3.0 (http://creativecommons.org/licenses/by-sa/3.0/)] </div> 
</div>
...
<i class="fas fa-table" title='Tab with table containing both property and concept words'></i> Norms {#table style="position:absolute !important; background-color:#FCFCFC;"}
=======================================================================
...
Column  {style="height:27000px"}
-----------------------------------------------------------------------

### **Filterable table containing both property and concept words**. Please scroll horizontally and vertically. Column information available by hovering on header. Columns may be simultaneously filtered and sorted (e.g., to find out range), and words may be searched below the header. [CSV](https://osf.io/ge7pn/){target="_blank"} and [Excel spreadsheet](https://osf.io/58gzs/){target="_blank"} also available.

<div style = "padding-top: 0px; text-align: justify; background-color:#FCFCFC;">

```{r}

# Arrange data set and create reactive version taking sidebar input

table_data = all[!is.na(all$word), c('cat', 'conc_cat', 'word', 'inflected_prop', 'main', 'Exclusivity', 'Perceptualstrength', 'Auditory',
...
renderReactable({
  reactable(selected_words(),
            ...
            striped = TRUE, pagination = FALSE, highlight = TRUE, compact = TRUE,
...
<i class="fas fa-chart-bar" aria-hidden="true"></i> Properties {data-orientation=rows data-height=3000 style="position:absolute !important;"}
=======================================================================
...
Row {data-height=310px padding-bottom=0 style='data-width:100%; padding-bottom:-290px; margin-bottom:2px;'}
-----------------------------------------------------------------------

### **Property words**. Please scroll horizontally and vertically. Column information available by hovering on header. Columns may be simultaneously filtered and sorted (e.g., to find out range), and words may be searched below the header. [CSV](https://osf.io/ge7pn/){target="_blank"} and [Excel spreadsheet](https://osf.io/58gzs/){target="_blank"} also available.

<div style = "padding-bottom: 160px; text-align: justify; background-color:#FCFCFC;">
...
renderReactable({
  reactable(selected_props()[properties_columns],
            ...
            defaultColDef = colDef(footerStyle = list(fontWeight = "bold")),
            height = 300, striped = TRUE, fullWidth = TRUE,
...
Row {data-height=800 style="data-height:100%;"}
-----------------------------------------------------------------------

### <span style = 'font-size: 15px !important;'> Principal component analysis (PCA) reflecting different relationships among the modalities. The visual and haptic modalities were related, whereas the auditory modality was more independent (see PCA loadings on side bar; cf. <a href="#cf-lc-english-norms">Lynott & Connell's 2009 data for English</a>). </span> {style="padding-top: 17px !important; text-align:justify; padding-bottom: 5px !important; padding-left: 4px !important; padding-right: 4px !important;"}
 ...
 ggplotly(
  ggplot( selected_props(), aes(RC1, RC2, label = as.character(word), color = main, 
    ...
    text = paste0(' ', '<span style="padding-top:3px; padding-bottom:3px; font-size:2em; color:#EEEEEE">', capitalize(word), '</b></span> ',
			...
			' ', '</b><br><span style="color:#EEEEEE"> Modality exclusivity: </span><b style="color:#EEEEEE">', round(Exclusivity, 2), '% ',
			...
			'</b><br><span style="color:#EEEEEE"> Contextual diversity for fem/masc inflected adjectives (lg10CD SUBTLEX-NL): </span><b style="color:#EEEEEE">', round(freq_lg10CD_SUBTLEXNL, 2), ' ',
...
<i class="fas fa-chart-bar" aria-hidden="true"></i> Concepts  {data-orientation=rows data-height=3000 style="position:absolute !important;"}
=======================================================================
...
### **Concept words.** Please scroll horizontally and vertically. Column information available by hovering on header. Columns may be simultaneously filtered and sorted (e.g., to find out range), and words may be searched below the header. [CSV](https://osf.io/ge7pn/){target="_blank"} and [Excel spreadsheet](https://osf.io/58gzs/){target="_blank"} also available.
...
# Variables to have on table
concepts_columns = c('word','main','conc_cat','Exclusivity','Perceptualstrength','Auditory',
                     'Haptic', 'Visual', 'SD_Auditory', 'SD_Haptic', 'SD_Visual',
                     'concrete_Brysbaertetal2014','letters','phonemes_DUTCHPOND',
...
renderReactable({
  reactable(selected_concs()[concepts_columns],
            ...
            columns = list(
              ...
              conc_cat = colDef(header = with_tooltip('Noun category',
...
<div style = "background-color: #FCFCFC; text-align: center; font-size: 15px; padding-top: 20px; padding-bottom: 5px;">
...
Row {style="height:1500;" data-padding=1}
-----------------------------------------------------------------------
...
ggplotly( ggplot(eng_props,
  aes(RC1, RC2, label = as.character(English_Word_Lynott_Connell_2009_2013), color = English_Main_Lynott_Connell_2009_2013,
    text = paste0(' ', '<span style="padding-top:3px; padding-bottom:3px; font-size:2em; color:#EEEEEE">', capitalize(English_Word_Lynott_Connell_2009_2013), '</b></span> ',
			...
			'</b><br><span style="color:#EEEEEE"> Perceptual strength: </span><b style="color:#EEEEEE">', round(English_Perceptualstrength_Lynott_Connell_2009_2013, 2),
			' ', '</b><br><span style="color:#EEEEEE"> Modality exclusivity: </span><b style="color:#EEEEEE">', round(English_Exclusivity_Lynott_Connell_2009_2013, 2) * 100, '% ',  
			# Multiplied by 100 to make percentage
			'</b><br><span style="color:#EEEEEE"> Auditory rating: </span><b style="color:#EEEEEE">', round(English_Auditory_Lynott_Connell_2009_2013, 2), ' ',
			'</b><br><span style="color:#EEEEEE"> Haptic rating: </span><b style="color:#EEEEEE">', round(English_Haptic_Lynott_Connell_2009_2013, 2), ' ',
			'</b><br><span style="color:#EEEEEE"> Visual rating: </span><b style="color:#EEEEEE">', round(English_Visual_Lynott_Connell_2009_2013, 2), ' ',
			'</b><br><span style="color:#EEEEEE; padding-bottom:3px;"> Number of letters: </span><b style="color:#EEEEEE">', English_Letters_Lynott_Connell_2009_2013, ' '
			 ) ) ) +
    labs(x = "Varimax-rotated Principal Component 1", y = "Varimax-rotated Principal Component 2") +
...
ggplotly( ggplot(properties_Dutch,
  aes(RC1, RC2, label = as.character(word), color = main,
    ...
    text = paste0(' ', '<span style="padding-top:3px; padding-bottom:3px; font-size:2em; color:#EEEEEE">', capitalize(word), '</b></span> ',
			...
			round(concrete_Brysbaertetal2014, 2), ' ',
			'</b><br><span style="color:#EEEEEE"> Number of letters: </span><b style="color:#EEEEEE">', letters, ' ',
			'</b><br><span style="color:#EEEEEE; padding-bottom:3px;"> Number of phonemes (DutchPOND): </span><b style="color:#EEEEEE">', 
			round(phonemes_DUTCHPOND, 2), ' '
			 ) ) ) +
  labs(x = "Varimax-rotated Principal Component 1", y = "Varimax-rotated Principal Component 2") +
...
ggplotly( ggplot(concepts_Dutch,
  aes(RC1, RC2, label = as.character(word), color = main,
    ...
    text = paste0(' ', '<span style="padding-top:3px; padding-bottom:3px; font-size:2em; color:#EEEEEE">', capitalize(word), '</b></span> ',
			'</b><br><span style="color:#EEEEEE"> Dominant modality: </span><b style="color:#EEEEEE">', main, ' ',
			'</b><br><span style="color:#EEEEEE"> Perceptual strength: </span><b style="color:#EEEEEE">', round(Perceptualstrength, 2), ' ', 			'</b><br><span style="color:#EEEEEE"> Modality exclusivity: </span><b style="color:#EEEEEE">', round(Exclusivity, 2), '% ',  
			# Multiplied by 100 to make percentage
			'</b><br><span style="color:#EEEEEE"> Auditory rating: </span><b style="color:#EEEEEE">', round(Auditory, 2), ' ',
			'</b><br><span style="color:#EEEEEE"> Haptic rating: </span><b style="color:#EEEEEE">', round(Haptic, 2), ' ',
			'</b><br><span style="color:#EEEEEE"> Visual rating: </span><b style="color:#EEEEEE">', round(Visual, 2), ' ',
...
Sound symbolism {data-orientation=rows data-padding=0.5 background-color=#FBFBFB style='width: 900px; margin: 0 auto;'}
=======================================================================

Row {data-height=300 data-padding=0.5 padding-top=34}
-----------------------------------------------------------------------
...
<div style = "background-color: #FCFCFC; padding-top: 50px; padding-left: 15px; padding-right: 1px; padding-bottom: 0px; margin-bottom:6px;">
...
<div style = "background-color: #FCFCFC; text-align: justify; padding-top: 27px; padding-right: 32px; padding-left: 32px; padding-bottom: 38px; margin-top: 0; margin-bottom: 7px;">
...
<div style = "background-color: #FCFCFC; padding-top: 50px; padding-right: 22px; padding-left: 1px; padding-bottom: 0px; margin-bottom:6px;">
...
### <span style="font-size:1.7em; color:black;"> &nbsp; **Property words** </span> {style="background-color:#FFFAF4; padding-top:0px; padding-bottom:15px !important; margin-bottom:2px !important;"}
...
### <span style="font-size:1.7em; color:black;"> &nbsp; **Concept words** </span> {style="background-color:#FFFEF3; padding-top:0px; padding-bottom:15px !important; margin-bottom:2px !important;"}
