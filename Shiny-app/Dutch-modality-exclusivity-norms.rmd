...
<a href="https://github.com/pablobernabeu/Modality-exclusivity-norms-747-Dutch-English-replication/blob/master/Shiny-app%2FDutch-modality-exclusivity-norms.rmd" style="color:#9FB05F; border-bottom:none !important;font-size: 15px; font-weight: bold; font-family: 'Courier New', Courier, monospace;"> <i class='fas fa-database' style='font-size:20px; color:#577787'></i> <i class='fab fa-r-project' style='font-size:20px; color:#526772'></i> Data and code for analyses and dashboard </a>
...
This dashboard presents the data and analyses of a set of modality exclusivity norms for Dutch. All this can be visualised through tables and plots that are accessible through the tabs above.

The modality norms, which are ratings of linguistic stimuli, served a twofold purpose: first, the creation of linguistic stimuli (see also Speed & Majid, 2017), and second, the replication of Lynott and Connell's (2009, 2013) analyses. In the collection of the ratings, forty-two respondents completed surveys for the properties or the concepts separately. Each word was rated by eight participants on average (see [raw data](https://osf.io/ge7pn/)), with a minimum of five (e.g., for *bevriezend*) and a maximum of ten ratings per word (e.g., for *donzig*). The [instructions to participants](https://osf.io/ungey/) were similar to those used by Lynott and Connell (2009, 2013), except that we elicited three modalities (auditory, haptic, visual) instead of five.
...
<i class="fas fa-table" title='Tab with table containing both property and concept words'></i> {#table style="position:absolute !important; background-color:#FCFCFC;"}
=======================================================================
...
# Extend initial of main modality into full word
levels(table_data$main)[levels(table_data$main) == 'a'] = 'Auditory'
levels(table_data$main)[levels(table_data$main) == 'h'] = 'Haptic'
levels(table_data$main)[levels(table_data$main) == 'v'] = 'Visual'

# Extend abbreviation of category
levels(table_data$cat)[levels(table_data$cat) == 'conc'] = 'Concept'
levels(table_data$cat)[levels(table_data$cat) == 'prop'] = 'Property'
...
Properties {data-orientation=rows data-height=3000 style="position:absolute !important;"}
=======================================================================
...
output$properties_csv = downloadHandler(
  ...
  content = function(file) {
	...
	drops = c('id','file','normed','word_eng','main_eng','perceptualstrength_eng','exc_eng','Aud_eng','Hap_eng','Vis_eng','lett_eng','RC1','RC2')
...
### **Property words**. Please scroll horizontally and vertically. Column information available by hovering on header. Columns may be simultaneously filtered and sorted (e.g., to find out range), and words may be searched below the header. CSV spreadsheet [also available](https://osf.io/ge7pn/){target="_blank"}.
...
Concepts  {data-orientation=rows data-height=3000 style="position:absolute !important;"}
=======================================================================
...
### **Concept words.** Please scroll horizontally and vertically. Column information available by hovering on header. Columns may be simultaneously filtered and sorted (e.g., to find out range), and words may be searched below the header. CSV spreadsheet [also available](https://osf.io/ge7pn/){target="_blank"}.
...
<b> Comparison with Lynott and Connell's (2009, 2013) English norms ([data sets](http://www.lancaster.ac.uk/staff/connelll/lab/norms.html)).</b> In both languages, properties were visibly more perceptual than concepts.
</div>
...
ggplotly( ggplot(eng_props,
  aes(RC1, RC2, label = as.character(word_eng), color = main_eng,
    text = paste0(' ', '<span style="padding-top:3px; padding-bottom:3px; font-size:2em; color:#EEEEEE">', capitalize(word_eng), '</b></span> ',
			'</b><br><span style="color:#EEEEEE"> Dominant modality: </span><b style="color:#EEEEEE">', main_eng, ' ',
			'</b><br><span style="color:#EEEEEE"> Perceptual strength: </span><b style="color:#EEEEEE">', round(perceptualstrength_eng, 2),
			' ', '</b><br><span style="color:#EEEEEE"> Modality exclusivity: </span><b style="color:#EEEEEE">', round(exc_eng, 2) * 100, '% ',  
			# Multiplied by 100 to make percentage
			'</b><br><span style="color:#EEEEEE"> Auditory rating: </span><b style="color:#EEEEEE">', round(Aud_eng, 2), ' ',
			'</b><br><span style="color:#EEEEEE"> Haptic rating: </span><b style="color:#EEEEEE">', round(Hap_eng, 2), ' ',
			'</b><br><span style="color:#EEEEEE"> Visual rating: </span><b style="color:#EEEEEE">', round(Vis_eng, 2), ' ',
			'</b><br><span style="color:#EEEEEE; padding-bottom:3px;"> Number of letters: </span><b style="color:#EEEEEE">', lett_eng, ' '
			 ) ) ) +
    labs(x = "Varimax-rotated Principal Component 1", y = "Varimax-rotated Principal Component 2") +
...
properties_Dutch2 = subset(all, subset = cat == 'prop')
...
concepts_Dutch2 = all[all$cat == 'conc' & c(all$normed == 'Dutch' | all$normed == 'Dut_Eng'),]
