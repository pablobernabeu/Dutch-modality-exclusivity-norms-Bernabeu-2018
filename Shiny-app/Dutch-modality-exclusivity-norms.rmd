...
<a href="https://osf.io/brkjw/files/github/Shiny-app/Dutch-modality-exclusivity-norms.rmd/" style="border-bottom:none !important"> <button style = 'background-color:#FFF9F6; outline:#C3AEAE dotted 0.8px; font-size: 15px; font-weight: bold; font-family: "Courier New", Courier, monospace;'> <i class="fab fa-r-project" aria-hidden="true" style='padding-top:4px; padding-bottom:6px; font-size:20px; color:#5A647B;'></i> Code for analyses and dashboard </button></a> 

<a style='font-size: 15px; font-weight: bold; font-family: "Courier New"' href="https://mybinder.org/v2/gh/pablobernabeu/Modality-exclusivity-norms-747-Dutch-English-replication/master?urlpath=rstudio"> Edit and run code in RStudio </a>
